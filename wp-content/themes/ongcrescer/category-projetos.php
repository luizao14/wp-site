		...
		<div class="row-content">
			...
			<div class="row botoes-cima">
				<div class="col-12 col-4 ml-auto">
                                    <a href="category-projetos" class="btn btn-warning btn-lg">PONTUAIS</a>
					<a href="category-projetos" class="btn btn-warning btn-lg">RECORRENTES</a>
					<a href="category-projetos" class="btn btn-warning btn-lg">ENCERRADOS</a>
				</div>
			</div><!-- row botoes-cima -->
