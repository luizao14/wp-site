...
/**
 * Class URA_SCREEN_OPTIONS
 * User Registration Aide - Class for adding new panels to the "Screen Options" box.
...
class URA_SCREEN_OPTIONS {
	...
	*/
	...
	/** 
	 * function append_screen_settings
	 ...
	 * @params string $screen Screen object (undocumented).
	 * @returns string The HTML code to append to "Screen Options"
	*/
	
	function append_screen_settings( $current, $screen ){
		global $hook_suffix;
		//exit( print_r( $current ) );
		//Sanity check
		if ( !isset( $screen->id ) ) {
			return $current;
		}
	...
	*/
	...
	/** 
	 * function get_panels_for_screen
	 * Get custom panels registered for a particular screen and/or page.
	 * @since 1.5.3.0
	 * @updated 1.5.3.0
	 * @access private
	 * @params string $screen_id Screen ID.
	 * @params string $page Optional. Page filename or hook name.
	 * @returns array Array of custom panels.
	*/
...
$ws_screen_options_versions['1.2'] = 'URA_SCREEN_OPTIONS';
